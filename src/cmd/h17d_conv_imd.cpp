...
{
    std::string prog_name(fs::path(argv[0]).filename());

    if (prog_name == "h8d_to_imd")
    {
        printf("It's h8d\n");
        return 0;
    }
    else if (prog_name == "h17v1_to_imd")
    {
        printf("It's h17v1\n");
        return 0;
    }
    else if (prog_name == "h17v2_to_imd")
    {
        printf("It's h17v2\n");
        return 0;
    }
